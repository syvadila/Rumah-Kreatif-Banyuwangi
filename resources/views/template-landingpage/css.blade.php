...
<link href="{{asset('public/landingpage/lib/animate/animate.min.css')}}" rel="stylesheet">
<link href="{{asset('public/landingpage/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
